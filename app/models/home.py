...
class HomeHero(Base):
    ...
    title: Mapped[str] = mapped_column(sa.String(255), nullable=False, default="Fast & Reliable Logistics Services")
    subtitle: Mapped[str | None] = mapped_column(sa.String(255), nullable=True)
    description: Mapped[str | None] = mapped_column(sa.Text, nullable=True)
    button_text: Mapped[str | None] = mapped_column(sa.String(100), nullable=True, default="Explore Services")
    button_url: Mapped[str | None] = mapped_column(sa.String(255), nullable=True, default="/services")
